...
# This file was *autogenerated* from the file UM_characters_decomposition.sage
...
class Matroid:
    ...
    def __init__(self, name, symmetric_group_n):
        ...
        self.trace_matrix = self.representations(self.rank)
...
def create_matroid(i, j):
    ...
    serialized_matroid = {
        ...
        "rank": matroid.rank,
        "symmetric_group": int(matroid.symmetric_group_n),
        "character_table_Sn": matroid.trace_matrix,
        "graded_dimensions_Chow": matroid.dimensions,
        "decomposition_into_irreducibles": matroid.representation_polynomial
    }

...
# This file was *autogenerated* from the file /Users/nnepal2/Documents/GitHub/ChowringofMatroids/braid-uniform-script.sage
...
class braidInterface:
    ...
    def monomial_equality(self, monomial, mapped_monomial):
        ...
        sorted_monomial = [(sorted(
            [tuple(sorted(segment)) for segment in m[_sage_const_0 ]]), m[_sage_const_1 ]
                                    ) for m in monomial]
...
def create_matroid(i):
    matroid = Matroid(matroids.CompleteGraphic(i), i-_sage_const_1 , braidInterface())
    serialized_matroid = {
